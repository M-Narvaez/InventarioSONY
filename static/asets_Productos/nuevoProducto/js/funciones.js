...
function validarProducto() {
    var idInput = document.formularioCrearProd.id;
    var nombreInput = document.formularioCrearProd.nombre;
    var descripcionInput = document.formularioCrearProd.descripcion;
    var proveedorInput = document.formularioCrearProd.proveedor;
    var bodegaInput = document.formularioCrearProd.bodega;
    var minimaInput = document.formularioCrearProd.minima;
    var swErrores = false;

    //console.log(idInput.value + " - " + nombreInput.value + " - "  );
    ...
    if(idInput.value.length == 0 || idInput.value.length < 4)
    {
